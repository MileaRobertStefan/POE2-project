...
class MaterialsTab(QWidget):
    ...
    def _on_scan(self) -> None:
        ...
        self._worker.minimize_window.connect(
            self._main.showMinimized, Qt.ConnectionType.QueuedConnection
        )
...
class TargetsTab(QWidget):
    ...
    def __init__(self, main_window: "MainWindow") -> None:
        ...
        self._save_list.setFixedWidth(230)
        self._save_list.setAlternatingRowColors(True)
        left.addWidget(self._save_list)
        ...
        self._mod_table.setMaximumHeight(200)
        right.addWidget(self._mod_table)
        ...
        self._fifty_table.setMaximumHeight(130)
        right.addWidget(self._fifty_table)
...
class CraftTab(QWidget):
    def __init__(self, main_window: "MainWindow") -> None:
        ...
        self._strategy_btns["scan_only"].setChecked(True)
